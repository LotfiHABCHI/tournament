	...
	<div class="container">
		...
		<table class="table table-striped">
			...
			<tbody>
				...
				@foreach ($ranking as $match) @if (Cookie::get('followed_team')== $match['team_id'])
				<tr class="table-primary">
					<td>{{ $match['rank'] }}</td>
					<td> <a href="{{route('teams.show', ['teamId'=>$match['team_id']])}}">{{$match['name']}}</a></td>
					<td>{{ $match['match_played_count'] }}</td>
					<td>{{ $match['won_match_count'] }}</td>
					<td>{{ $match['draw_match_count'] }}</td>
					<td>{{ $match['lost_match_count'] }}</td>
					<td>{{ $match['goal_for_count'] }}</td>
					<td>{{ $match['goal_against_count'] }}</td>

...
function testTeamLosesMatch(): void 
{
    ...
    function testTeamMakesADraw(): void 
    {
        $this->assertNotTrue($this->ranking->teamMakesADraw(1, $this->match0));
        $this->assertNotTrue($this->ranking->teamMakesADraw(3, $this->match0));
        $this->assertTrue($this->ranking->teamMakesADraw(4, $this->match1));
        $this->assertTrue($this->ranking->teamMakesADraw(2, $this->match1));
        $this->assertNotTrue($this->ranking->teamMakesADraw(8, $this->match1));
        $this->assertNotTrue($this->ranking->teamMakesADraw(3, $this->match2));
        $this->assertNotTrue($this->ranking->teamMakesADraw(2, $this->match2));
        $this->assertNotTrue($this->ranking->teamMakesADraw(4, $this->match0));
    }
